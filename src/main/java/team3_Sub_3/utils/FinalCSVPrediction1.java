...
public class FinalCSVPrediction1 {
	...
	public void finalCsv(Map<String, Integer> weaponMap, Map<String, Integer> longevityMap,
		...
		List<String> uniqueCharName = Utility.getColumnSpecificDataFromCsvFile(Constants.DEATHS_TEST, 1);

		/*
		 * Even for Train Odd for Test
		 */

		File csvFinalFile = new File(Constants.FINAL_TEST_CSV);
